...
router.delete('/:model/:id', asyncWrapper (async(req, res) => {
    const result = await req.model.delete(req.params.id);
    res.status(202).json(result);
}));

//get all categories
router.get('/:model', asyncWrapper (async (req, res) => {
