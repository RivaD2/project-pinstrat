...
router.put('/:model/:id', paramsToModel, asyncWrapper, controller.putIdHandler);

//deletes the record with the :id specified`
router.delete('/:model/:id', paramsToModel, asyncWrapper, controller.deleteIdHandler);

//get all categories
router.get('/:model', paramsToModel, asyncWrapper, controller.getHandler);
